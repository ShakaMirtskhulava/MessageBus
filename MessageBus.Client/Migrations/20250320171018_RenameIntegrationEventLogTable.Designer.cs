...
namespace MessageBus.Client.Migrations
{
    ...
    [Migration("20250320171018_RenameIntegrationEventLogTable")]
    partial class RenameIntegrationEventLogTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MessageBus.IntegrationEventLog.EF.EFCoreIntegrationEventLog", b =>
                {
                    ...
                    b.ToTable("INTEGRATION_EVNET_LOG_TABLE_NAME", (string)null);
                });
